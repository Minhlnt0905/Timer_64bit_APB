task run_test();
	...
	begin
		...
		test_bench.wr_transfer(12'h1C, 32'h0000_0000);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'hffff_ffff);
		test_bench.rd_transfer(12'h1C, out_rd);		
		...
		test_bench.wr_transfer(12'h1C, 32'h5555_5555);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0001) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'haaaa_aaaa);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'h3333_3333);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'h4444_4444);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'h6666_6666);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'h7777_7777);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'h8888_8888);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'h1111_1111);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0001) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h1C, 32'h2222_2222);
		test_bench.rd_transfer(12'h1C, out_rd);		
		if (out_rd == 32'h0000_0001) begin
			$display("==================================================================");
