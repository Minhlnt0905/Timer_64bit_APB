task run_test();
	...
	begin
		...
		test_bench.wr_transfer(12'h18, 32'h0000_0000);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h18, 32'hffff_ffff);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
			$display("============PASSED: Correct 2nd write case, 32'h0000_0000==========");
			$display("==================================================================");
		end else begin
			$display("=====================================================================================");
		...
		test_bench.wr_transfer(12'h18, 32'h5555_5555);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
			$display("============PASSED: Correct 3rd write case, 32'h0000_0000==========");
			$display("==================================================================");
		end else begin
			$display("=====================================================================================");
			$display("============%t FAILED: Wrong 3rd write case, exp: 32'h0000_0000, actual: 32'h%h==========", $time, out_rd);
			$display("=====================================================================================");
			fail_num = fail_num + 1;
		end
		
		test_bench.wr_transfer(12'h18, 32'haaaa_aaaa);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h18, 32'h3333_3333);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h18, 32'h4444_4444);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h18, 32'h6666_6666);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h18, 32'h7777_7777);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h18, 32'h8888_8888);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
		...
		test_bench.wr_transfer(12'h18, 32'h1111_1111);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
			$display("============PASSED: Correct 6th byte access 4'b0011 pstrb, 32'h0000_0000==========");
			$display("==================================================================");
		end else begin
			$display("=====================================================================================");
			$display("============%t FAILED: Wrong 6th byte access 4'b0011 pstrb, exp: 32'h0000_0000, actual: 32'h%h==========", $time,  out_rd);
			$display("=====================================================================================");
			fail_num = fail_num + 1;
		end

		test_bench.pstrb=4'h6;
		test_bench.wr_transfer(12'h18, 32'h2222_2222);
		test_bench.rd_transfer(12'h18, out_rd);		
		if (out_rd == 32'h0000_0000) begin
			$display("==================================================================");
			$display("============PASSED: Correct 7th byte access 4'b0110 pstrb, 32'h0000_0000==========");
			$display("==================================================================");
		end else begin
			$display("=====================================================================================");
			$display("============%t FAILED: Wrong 7th byte access 4'b0110 pstrb, exp: 32'h0000_0000, actual: 32'h%h==========", $time,  out_rd);
			$display("=====================================================================================");
			fail_num = fail_num + 1;
		end
